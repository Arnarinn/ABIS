...
class CarUi:
    ...
    def printTable(self, myCarList):
     ...
     """def printCMTable(self, myCarList):
        ...
        # columns are filled with strings
        # columns are aligned to the left
        print('%-15s%-15s%-15s%-15s%-15s-15s%-15s%-10s%-10s%-10s-15s%-10s%-10s%-10s%-10s-%10s' % ('|' + 'Type', '|' + 'Manufacturer', \
        ...
        print('==================================================')
        for x in myCarList:
            print('%-15s%-15s%-15s%-15s%-15s-15s%-15s%-10s%-10s%-10s-15s%-10s%-10s%-10s%-10s-%10s' % ('|' + x.getType(),\
                '|' + x.getManufacturer(),\
